...
var createItemSize = function createItemSize(sizes) {
  ...
  if (sizes.length == 0) {
    ...
    sizes.forEach(function (size) {
      str += "\n            <input type=\"radio\" id=\"size_".concat(size, "\" class=\"parameters__input\" name=\"size\" value=\"").concat(size, "\">\n            <label for=\"size_").concat(size, "\" class=\"parameters__label\">").concat(size, "</label>\n            ");
    });
    return str;
  }
};
...
var createItemColor = function createItemColor(colors) {
  ...
  if (colors.length == 0) {
    ...
    colors.forEach(function (color) {
      str += "\n            <input type=\"radio\" id=\"color_".concat(color, "\" class=\"parameters__input\" name=\"color\" value=\"").concat(color, "\">\n            <label for=\"color_").concat(color, "\" class=\"parameters__label\">").concat(color, "</label>\n            ");
    });
    return str;
  }
};
